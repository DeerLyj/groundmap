...
export const TRANSLATIONS = {
  zh: {
    ...
    "memory.title": "个人工作记忆",
    "memory.desc": "候选记忆不会自动影响回答；只有你确认后才会进入长期记忆。普通对话不会自动保存。",
    "memory.candidates": "待确认候选",
    "memory.confirmed": "已确认记忆",
    "memory.rejected": "已拒绝记录",
    "memory.empty_candidates": "暂无待确认候选。",
    "memory.empty_confirmed": "暂无已确认记忆。",
    "memory.scope": "适用范围：{scope}",
    "memory.confidence": "置信度：{confidence}",
    "memory.confirm": "确认进入长期记忆",
    "memory.reject": "拒绝并保留记录",
    "memory.confirmed_badge": "已确认",
    "memory.rejected_badge": "已拒绝",
    "memory.processing": "处理中…",
    "memory.confirmed_ok": "已确认，下一轮查询会读取。",
    "memory.rejected_ok": "已拒绝，文件保留为历史记录。",
    "memory.error": "记忆操作失败：{error}",
    "projects.title": "项目总控",
    "projects.desc": "项目状态、决策记录和可迁移的 Context Pack。",
    "projects.empty": "暂无项目状态记录。",
    "projects.invalid": "项目状态需要修复",
    "projects.status": "状态：{status}",
    "projects.updated": "更新时间：{date}",
    "projects.decisions": "决策记录：{n}",
    "projects.executions": "执行记录：{n}",
    "projects.no_executions": "暂无行动—结果—修正记录。",
    "projects.execution_confirmed": "Human 已确认",
    "projects.execution_pending": "待 Human 确认",
    "projects.control_complete": "P2 业务闭环已完成",
    "projects.control_incomplete": "P2 业务闭环待补",
    "projects.next_action": "下一行动：{action}",
    "projects.open": "打开项目",
    "projects.context": "生成 Context Pack",
    "projects.context_ready": "Context Pack 已生成：{path}",
    "projects.context_source": "来源文件",
    "projects.no_brief": "未提供项目简介。",
    "projects.no_context": "Context Pack 尚未生成。",
    "projects.state_confirmed": "项目状态已由 Human 确认",
    "projects.state_pending": "项目状态待 Human 确认",
    "projects.decision_confirmed": "Human 已确认",
    "projects.confirm": "确认",
    "projects.confirming": "确认中…",
    "projects.confirm_prompt": "确认当前内容并标记为 Human 已确认？",
    "projects.confirm_failed": "确认失败，请检查项目服务或直接审阅文件。",
    "projects.deliverables": "成果版本：{n}",
    "projects.no_deliverables": "暂无成果草稿。",
    "projects.deliverable_reviewed": "Human 已审阅",
    "projects.deliverable_draft": "待 Human 审阅",
    "projects.deliverable_sources": "本地证据：{n} 项",
    "projects.deliverable_confirm": "确认此版本",
    "projects.deliverable_confirm_prompt": "确认已审阅当前成果版本，并将其引用回写到项目状态？",
    "evidence.title": "证据查看器",
    "evidence.locator": "稳定定位",
    "evidence.original": "原始证据",
    "evidence.open_original": "打开原件",
    "evidence.download_hint": "该格式可安全下载；提取后的可读内容显示在下方。",
    "evidence.extracted": "提取内容",
    "evidence.open_page": "打开派生页面",
    ...
    "walkthrough.card.search": "搜索卡片 · 一次可解释的本地全文检索。它同时搜索 wiki/ 与 derived/；中文连续文本展开为二元字符片段，不使用向量库、切片或 embedding。注意：搜索只负责召回候选，谁先读仍由下一步按页面类型和证据质量决定。",
    ...
    "learn.search.score_formula": "中文：标题词项 ×5、Wiki 正文 ×1、derived 正文 ×2（每个词项每字段最多一次）；英文沿用标题次数 ×5 + 正文次数 ×1。",
    ...
    "learn.cmd.note.search": "在 wiki/ 与 derived/ 里搜关键词",
  ...
  en: {
    ...
    "memory.title": "Personal work memory",
    "memory.desc": "Candidates never affect answers automatically; only your confirmation promotes them to long-term memory. Ordinary chats are not saved automatically.",
    "memory.candidates": "Candidates to review",
    "memory.confirmed": "Confirmed memory",
    "memory.rejected": "Rejected history",
    "memory.empty_candidates": "No candidates waiting for review.",
    "memory.empty_confirmed": "No confirmed memory yet.",
    "memory.scope": "Scope: {scope}",
    "memory.confidence": "Confidence: {confidence}",
    "memory.confirm": "Confirm long-term memory",
    "memory.reject": "Reject and keep history",
    "memory.confirmed_badge": "confirmed",
    "memory.rejected_badge": "rejected",
    "memory.processing": "processing…",
    "memory.confirmed_ok": "Confirmed; the next query will read it.",
    "memory.rejected_ok": "Rejected; the file remains as history.",
    "memory.error": "Memory operation failed: {error}",
    "projects.title": "Project control",
    "projects.desc": "Project state, decision records, and portable Context Packs.",
    "projects.empty": "No project state records yet.",
    "projects.invalid": "Project state needs attention",
    "projects.status": "Status: {status}",
    "projects.updated": "Updated: {date}",
    "projects.decisions": "Decisions: {n}",
    "projects.executions": "Execution records: {n}",
    "projects.no_executions": "No action-result-revision record yet.",
    "projects.execution_confirmed": "Confirmed by Human",
    "projects.execution_pending": "Awaiting Human confirmation",
    "projects.control_complete": "P2 business loop complete",
    "projects.control_incomplete": "P2 business loop incomplete",
    "projects.next_action": "Next action: {action}",
    "projects.open": "Open project",
    "projects.context": "Build Context Pack",
    "projects.context_ready": "Context Pack built: {path}",
    "projects.context_source": "Source files",
    "projects.no_brief": "No project brief provided.",
    "projects.no_context": "Context Pack has not been built yet.",
    "projects.state_confirmed": "Project state confirmed by Human",
    "projects.state_pending": "Project state awaits Human confirmation",
    "projects.decision_confirmed": "Confirmed by Human",
    "projects.confirm": "Confirm",
    "projects.confirming": "Confirming…",
    "projects.confirm_prompt": "Confirm the current content as reviewed by Human?",
    "projects.confirm_failed": "Confirmation failed; inspect the project service or file directly.",
    "projects.deliverables": "Deliverable versions: {n}",
    "projects.no_deliverables": "No deliverable drafts yet.",
    "projects.deliverable_reviewed": "Reviewed by Human",
    "projects.deliverable_draft": "Awaiting Human review",
    "projects.deliverable_sources": "Local evidence: {n}",
    "projects.deliverable_confirm": "Confirm version",
    "projects.deliverable_confirm_prompt": "Confirm that you reviewed this version and write its reference back to project state?",
    "evidence.title": "Evidence viewer",
    "evidence.locator": "Stable locator",
    "evidence.original": "Original evidence",
    "evidence.open_original": "Open original",
    "evidence.download_hint": "This format is available as a safe download; extracted readable content appears below.",
    "evidence.extracted": "Extracted content",
    "evidence.open_page": "Open derived page",
    ...
    "walkthrough.card.search": "Search card · one explainable local full-text query across wiki/ and derived/. Continuous Chinese text expands into character bigrams; no vector store, chunking, or embeddings are used. Search only recalls candidates; the next step still chooses what to read by page type and evidence quality.",
    ...
    "learn.search.score_formula": "Chinese: title term ×5, Wiki body ×1, derived body ×2 (once per term per field); English keeps title occurrences ×5 + body occurrences ×1.",
    ...
    "learn.cmd.note.search": "Keyword search across wiki/ and derived/",
